declare module 'keycloak-connect' {
    ...
    /**
     * This is a copy from the keycloak.d.ts file in node_modules/keycloak-connect
     * It is extended to match the types with the KJK source code after the Keycloak upgrade to v21
     */
    ...
    interface KeycloakConnectStatic {
        new (
            ...
            config?: KeycloakConnect.KeycloakConfig | string,
    ...
    declare namespace KeycloakConnect {
        ...
        export interface GrantedRequest extends express.Request {
            kauth: { grant?: Grant };
        }
        ...
        interface GrantManager {
            ...
            obtainFromCode(
                ...
                sessionid?: string,
                sessionHost?: string,
                callback?: (err: Error, grant: Grant) => void,
            ): Promise<Grant>;
