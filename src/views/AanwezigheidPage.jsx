        ...
        return (
            <Page messages={messages}>
                <Header breadcrumbs={breadcrumbs} role={role} user={user}>
                    {role === 'marktondernemer' && <OndernemerProfileHeader user={ondernemer} />}
                </Header>
                <Content>
                    {role === 'marktmeester' && (
                        <>
                    ...
                    <Alert type="warning wide" inline="true" title="Digitaal ingedeeld? Dan ook komen!">
                        <p>Een aangevinkte dag betekent dat u (of uw vervanger) aanwezig zal zijn.</p>
                        <p className="sub">
                            Bent u er niet? Dan brengen wij het marktgeld de volgende keer dat u op de markt bent in
                            rekening. Indien u niet aan uw betaalverplichting voldoet, zijn wij genoodzaakt uw
                            vergunning in te trekken totdat u heeft betaald.
                        </p>
                    </Alert>
