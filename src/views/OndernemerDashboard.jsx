...
class OndernemerDashboard extends React.Component {
    ...
    render() {
        ...
        const sollicitaties = ondernemer.sollicitaties.filter(
            soll => !!markten.find(markt => markt.id === soll.markt.id),
        );
                ...
                <Content>
                    <div className="Section Section--column">
                        <a
                            ...
                            className="Link"
                        >
                            Informatie over digitaal Indelen van de markt
                        </a>
                    ...
                    {marktenMetSollicitatie.length == 0 ? (
                        <p>
                            U hebt geen sollicitatie voor een markt die digitaal wordt ingedeeld. Klopt dit niet, neem
                            dan contact op met de marktmeesters via 14 020 of{' '}
